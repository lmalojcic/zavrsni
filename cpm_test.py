...
for i in range(n):
    ...
    coms_louvain_karate = algorithms.cpm(G_karate)
...
for i in range(n):
    ...
    coms_louvain_florentine = algorithms.cpm(G_florentine)
...
for i in range(n):
    ...
    coms_louvain_cities = algorithms.cpm(G_cities)
...
coms_amazon = algorithms.cpm(G_amazon)
