...
for i in range(100):
    ...
    coms_louvain_karate = algorithms.demon(G_karate, min_com_size=3, epsilon=0.25)
...
for i in range(100):
    ...
    coms_louvain_cities = algorithms.demon(G_cities, min_com_size=3, epsilon=0.25)
...
#AMAZON
# NE IZVRSAVA SE U RAZUMNOM VREMENU
# amazon_start = timeit.default_timer()
# coms_amazon = algorithms.demon(G_amazon, min_com_size=3, epsilon=0.25)
